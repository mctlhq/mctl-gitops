...
Not ROADMAP. Scored for Type I design as of 2026-08-17. Owner is the
...
|---|---|---|---|---|---|---|
| R1 | GitHub org without required MFA | CC6 | High | Enable org 2FA requirement; evidence in `evidence/github-org-mfa.md` | High until `true` | Open — REST cannot toggle; owner UI |
...
| R7 | Admin GitHub ruleset bypass | CC1/CC5 | High | Documented exception + emergency-change.md + quarterly review | Medium | Compensating |
...
| R12 | PSS still baseline | CC6 | Low | audit/warn restricted; step 2 after 29.08 (F18) | Low | Accepted Horizon 3 |
