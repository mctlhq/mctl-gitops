## Summary (2026-06-13 09:00 UTC)

**60 proposals** across 11 repos (51 merged · 4 proposed · 5 rejected · 0 in-progress) — no state changes since [#414](https://github.com/mctlhq/mctl-gitops/issues/414) (2026-06-11). 2026-06-12 report skipped. 0 PRs merged in 24 h. 0 bot commits (mctl-agents). 2 new stale-PR issues opened ([#419](https://github.com/mctlhq/mctl-gitops/issues/419) mctl-pairdesk#57, [#420](https://github.com/mctlhq/mctl-gitops/issues/420) mctl-portal#23). mctl-telegram stuck proposals (#390/#391) now 19 days; mctl-pairdesk #412/#413 now 9 days. All 12 stale-PR tracking issues (+2 d comments). Daily-report issue: mctl-gitops#421.

---

## Proposal pipeline state

_Previous snapshot: 2026-06-11 / [#414](https://github.com/mctlhq/mctl-gitops/issues/414) — identical today, no state changes. (2026-06-12 skipped.)_
...
| mctl-pairdesk | **issue-52-p3-add-native-showconfirm-for-destructiv** | **proposed** | — | still (9 d ⚠⚠ → [#412](https://github.com/mctlhq/mctl-gitops/issues/412)) |
| mctl-pairdesk | **issue-53-p3-create-order-has-no-ttl-expiry-picker** | **proposed** | — | still (9 d ⚠⚠ → [#413](https://github.com/mctlhq/mctl-gitops/issues/413)) |
...
| mctl-telegram | **issue-213-deploy-canary-prometheusrule-to-cluster** | **proposed** | — | still (19 d ⚠⚠ → [#390](https://github.com/mctlhq/mctl-gitops/issues/390)) |
| mctl-telegram | **issue-214-self-service-canonicalize-client-tier-in** | **proposed** | — | still (19 d ⚠⚠ → [#391](https://github.com/mctlhq/mctl-gitops/issues/391)) |
...
_(Previous 2026-06-11 / [#414](https://github.com/mctlhq/mctl-gitops/issues/414): identical — no state changes. 2026-06-12 skipped.)_

---

## Pipeline diff (vs 2026-06-11 / #414)

> Note: 2026-06-12 report was skipped — no snapshot commit or daily-report issue found for that date.
...
- **Still proposed (unchanged):**
  - `mctl-pairdesk/issue-52` — **9 days** ⚠⚠ (follow-up comment → [#412](https://github.com/mctlhq/mctl-gitops/issues/412))
  - `mctl-pairdesk/issue-53` — **9 days** ⚠⚠ (follow-up comment → [#413](https://github.com/mctlhq/mctl-gitops/issues/413))
  - `mctl-telegram/issue-213` — **19 days** ⚠⚠ (follow-up comment → [#390](https://github.com/mctlhq/mctl-gitops/issues/390))
  - `mctl-telegram/issue-214` — **19 days** ⚠⚠ (follow-up comment → [#391](https://github.com/mctlhq/mctl-gitops/issues/391))

---

## Recent merged PRs (24 h)

Window: 2026-06-12T09:00Z → 2026-06-13T09:00Z

_No PRs merged in the last 24 h across `mctlhq/*`._

Note: 14 new PRs were opened on 2026-06-12 (mctl-gitops #415/#416/#417, mctl-portal #24/#25, mctl-web #26–#29, mctl-agents #42/#43, mctl-docs #23–#25) — all remain open.

---

## Bot commits (last 26 h)

No bot commits (mctl-agents) in the last 26 h. Last snapshot: `f5cc3ee` — 2026-06-11 09:16 UTC.
...
|----------|------|---------------|--------|
| mctl-telegram/issue-213 | **19 d** | [#390](https://github.com/mctlhq/mctl-gitops/issues/390) | comment added ✓ |
| mctl-telegram/issue-214 | **19 d** | [#391](https://github.com/mctlhq/mctl-gitops/issues/391) | comment added ✓ |
| mctl-pairdesk/issue-52 | **9 d** | [#412](https://github.com/mctlhq/mctl-gitops/issues/412) | comment added ✓ |
| mctl-pairdesk/issue-53 | **9 d** | [#413](https://github.com/mctlhq/mctl-gitops/issues/413) | comment added ✓ |

### New stale-PR issues opened

| new issue | tracked PR | days stale | was watching since |
|-----------|-----------|------------|--------------------|
| [#419](https://github.com/mctlhq/mctl-gitops/issues/419) | [mctl-pairdesk#57](https://github.com/mctlhq/mctl-pairdesk/pull/57) fix: remove inline keyboard | 8 d | 2026-06-11 #414 |
| [#420](https://github.com/mctlhq/mctl-gitops/issues/420) | [mctl-portal#23](https://github.com/mctlhq/mctl-portal/pull/23) chore(backstage): bump 1.51.1 | 8 d | 2026-06-11 #414 |

### Existing stale-PR issues (follow-up comments added, +2 d from last report)

| issue | tracked PR | days stale |
|-------|-----------|------------|
| [#392](https://github.com/mctlhq/mctl-gitops/issues/392) | [mctl-gitops#84](https://github.com/mctlhq/mctl-gitops/pull/84) [wip] per-proposal claim | **44 d** |
| [#393](https://github.com/mctlhq/mctl-gitops/issues/393) | mctl-agents #15/#16/#17 orchestrator | **35 d** |
| [#400](https://github.com/mctlhq/mctl-gitops/issues/400) | [mctl-portal#7](https://github.com/mctlhq/mctl-portal/pull/7) /proposals page | **34 d** |
| [#401](https://github.com/mctlhq/mctl-gitops/issues/401) | [mctl-api#47](https://github.com/mctlhq/mctl-api/pull/47) mctl_create_preview | **34 d** |
| [#402](https://github.com/mctlhq/mctl-gitops/issues/402) | [mctl-gitops#217](https://github.com/mctlhq/mctl-gitops/pull/217) incident responder CronWorkflow | **28 d** |
| [#403](https://github.com/mctlhq/mctl-gitops/issues/403) | [mctl-agent#20](https://github.com/mctlhq/mctl-agent/pull/20) statefulset-replicas-mismatch | **28 d** |
| [#404](https://github.com/mctlhq/mctl-gitops/issues/404) | [mctl-telegram#146](https://github.com/mctlhq/mctl-telegram/pull/146) landing page UX | **22 d** |
| [#405](https://github.com/mctlhq/mctl-gitops/issues/405) | [mctl-gitops#306](https://github.com/mctlhq/mctl-gitops/pull/306) prometheus-pushgateway | **19 d** |
| [#406](https://github.com/mctlhq/mctl-gitops/issues/406) | [mctl-telegram#221](https://github.com/mctlhq/mctl-telegram/pull/221) auto-persist tier=client | **18 d** |
| [#407](https://github.com/mctlhq/mctl-gitops/issues/407) | [mctl-telegram#248](https://github.com/mctlhq/mctl-telegram/pull/248) edit/delete/forward/react | **14 d** |

### Watching for next run (not yet stable / skipped per convention)

- `mctl-api#72` (CI bump, 5 d) — crosses 7 d on 2026-06-15 if no activity
- `mctl-telegram#267`, `#268` (dep-bumps, 7 d) — skipped per dep-bump convention
- `mctl-telegram#263` (release-please, 7 d) — skipped per release-PR convention
- `mctl-api#70`, `#71` (CI dep-bumps, 12 d) — skipped per dep-bump convention
- `mctl-api#64`, `mctl-docs#17` (release PRs, 14 d) — skipped per release-PR convention
- `mctl-api#51`, `#55–#58` (dep-bumps, 26–33 d) — skipped per dep-bump convention
- `mctl-telegram#34–#37`, `#39` (GHA dep-bumps, 8 d) — skipped per dep-bump convention
