    ...
    args:
      - |
        ...
        async function check() {
          ...
          if (failureCount > 0 && creds.refreshFailureToken && creds.refreshFailureToken !== creds.refreshToken) {
            process.stdout.write('[mctl-refresh] ' + new Date().toISOString() + ' credentials replaced externally, clearing ' + failureCount + ' stale failures\n');
