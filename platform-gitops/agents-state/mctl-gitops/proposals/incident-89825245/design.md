...
itself or in proposal issue-364. The run's own post-deploy-verify step
...
A second, independent shepherd run (issue-305,
argo-mctl-agents-shepherd-78067ca0-1789825049) hit the identical
post-deploy-verify failure a few minutes earlier, which corroborates that
this is a standing environment condition, not something particular to this
one workflow or proposal.
...
flagging it, and future shepherd runs (including any retry of issue-364)
