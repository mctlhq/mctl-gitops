...
4. [ ] No image tag bump needed — this is a workflow-template-only config
   ...
   Note: if incident-89786271's proposal already applied this exact change,
   this task becomes a no-op verification instead of a duplicate edit.
