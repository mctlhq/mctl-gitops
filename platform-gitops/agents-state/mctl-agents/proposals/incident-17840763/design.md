...
5 consecutive failures (also see proposals incident-17840817, incident-17840799,
incident-17840781, incident-17840745). Each run crashes after 170-220 seconds (~3 minutes).

Loki returned zero log lines for `admins/mctl-agents` over a 24-hour window. The Argo
Workflow UI at https://workflows.mctl.ai/workflows/argo-workflows/mctl-agents-incidents-1784076300
...
Apply the appropriate fix as described in incident-17840817/design.md. A single fix
should resolve all 5 incidents in this batch.
