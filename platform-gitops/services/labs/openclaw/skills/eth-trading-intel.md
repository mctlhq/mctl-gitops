...
Если bias = "Нет преимущества":

```
ETH снапшот (2026-05-05 12:34 UTC)
Bias: Нет преимущества
Лонг скор: 38 / Шорт скор: 41
Уверенность: низкая  Режим: флэт

Нет актуального сетапа. Рынок во флэте, индикаторы смешанные.
Причины:
- ...
```
...
**ЗАПРЕЩЕНО** (на любом языке): "BUY NOW", "SELL NOW", "open long immediately", "open short immediately", "go long", "go short", "ПОКУПАЙ", "ПРОДАВАЙ", "открой лонг сейчас", "открой шорт сейчас", "вставай в лонг", "вставай в шорт", обещания цены/направления, советы про размер позиции/плечо, "guaranteed"/"гарантированно", "100%", "сейчас отличный вход".

**РАЗРЕШЕНО**: "наблюдение за лонг-сетапом", "наблюдение за шорт-сетапом", "возможный сквиз", "требуется ручной разбор", "ждать ретест", "не догонять", "преимущества нет", "ждать подтверждение", "крупняк/смарт мани на стороне лонга/шорта", "флэт без направления".
