...
Static text. Список всех 21 команд (16 base + 5 Phase 1.6 indicator commands) с usage и one-line описанием. Никаких CoinGlass calls. Should включать:
- Trading: /eth, /btc, /sol, /scan, /risk, /pulse, /funding, /oi, /etf, /why, /last
- Indicators (Phase 1.6, local Bybit kline): /rsi, /macd, /bb, /adx, /heatmap
